...
func (x *GameReply) GetCompany() string {
	if x != nil {
		return x.Company
	}
	return ""
...
func (x *GameReply) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *GameReply) GetReleaseYear() int32 {
	if x != nil {
...
var file_games_proto_rawDesc = []byte{
	...
	,
...
var file_games_proto_goTypes = []interface{}{
	(*GameRequest)(nil), // 0: games.GameRequest
	(*GameReply)(nil),   // 1: games.GameReply
}
var file_games_proto_depIdxs = []int32{
	0, // 0: games.GameService.GetGames:input_type -> games.GameRequest
	1, // 1: games.GameService.GetGames:output_type -> games.GameReply
...
type GameServiceClient interface {
	GetGames(ctx context.Context, in *GameRequest, opts ...grpc.CallOption) (*GameReply, error)
}
...
func (c *gameServiceClient) GetGames(ctx context.Context, in *GameRequest, opts ...grpc.CallOption) (*GameReply, error) {
	out := new(GameReply)
	err := c.cc.Invoke(ctx, "/games.GameService/GetGames", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GameServiceServer interface {
	GetGames(context.Context, *GameRequest) (*GameReply, error)
}
...
func (*UnimplementedGameServiceServer) GetGames(context.Context, *GameRequest) (*GameReply, error) {
...
func _GameService_GetGames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/games.GameService/GetGames",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServiceServer).GetGames(ctx, req.(*GameRequest))
	}
